...
echo "  2. Hub: deploy via GitHub/CI to dc-hub.pages.dev (build: npm run build, output: dist/)"
echo "  3. Worker: dc-hub-gateway deployed. Add route in Cloudflare dashboard:"
echo "     Workers & Pages > dc-hub-gateway > Settings > Triggers > Add route"
